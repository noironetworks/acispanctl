...
var getSessionsCmd = &cobra.Command{
	Use:   "sessions",
	Short: "Print all VSPAN sessions",
	Long: `This command will retrieve and print all the VSPAN sessions
configured on the ACI.`,
	Run: func(cmd *cobra.Command, args []string) {
		//acilib.GetAllTenants()
		acispanctl.PrintAllVSPANSessions()
		//acilib.PrintAllOpflexIDEp()
		//fmt.Println("get sessions called")
	},
}
