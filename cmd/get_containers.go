...
var getContainersCmd = &cobra.Command{
	Use:   "containers",
	Short: "Print all container - opflexIDEps",
	Long: `This command will retrieve and print all the containers
in the ACI kubernetes cluster.`,
	Run: func(cmd *cobra.Command, args []string) {
		//fmt.Println("get sessions called")
		acispanctl.PrintAllOpflexIDEp()
	},
}
